...
ช่วง *_range_low / *_range_high มาจากตาราง Muscle fat analysis หรือ Overall analysis ช่วง Standard (Low–High) ของน้ำหนัก/กล้ามเนื้อโครงร่าง/มวลไขมัน/มวลกล้ามเนื้อ/อายุร่างกาย ตามลำดับ
